...
<div align="center">
  <img src="https://latex.codecogs.com/svg.image?\color{white}\min_{X}&space;\left\{&space;\frac{1}{2}\|\mathcal{A}(X)&space;-&space;X_{corrupt}\|_2^2&space;&plus;&space;\sigma\|X\|_*&space;&plus;&space;\sigma\|\tilde{X}\|_*&space;\right\}" alt="Optimization Formula">
</div>
...
* **`utils.py`**: A collection of mathematical tools and helper functions, including:
